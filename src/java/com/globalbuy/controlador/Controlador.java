package com.globalbuy.controlador;

import com.globalbuy.config.Fecha;
import com.globalbuy.modelo.Carrito;
import com.globalbuy.modelo.Cliente;
import com.globalbuy.modelo.ClienteDAO;
import com.globalbuy.modelo.Compra;
import com.globalbuy.modelo.ComprasDAO;
import com.globalbuy.modelo.DetalleCompra;
import com.globalbuy.modelo.Pago;
import com.globalbuy.modelo.Producto;
import com.globalbuy.modelo.ProductoDAO;
import java.io.File;
        ...
        switch (accion) {
            ...
            case "Validar":
                ...
                if (cl.getId() != 0) {
                    ...
                    correo = cl.getEmail();
                    session.setAttribute("nombreUsuario", cl.getNombres());
                    request.setAttribute("mensaje", "Bienvenido, " + cl.getNombres() + "!");
                } else {
            ...
            case "Registrar":
                ...
                cl.setPass(pas);
                cl.setDireccion(dir);
                int resultado = cldao.AgregarCliente(cl);
                if (resultado == 1) {
                    request.setAttribute("mensaje", "Registro exitoso. Bienvenido, " + nom + "!");
                } else {
                    request.setAttribute("error", "El correo electrónico ya está en uso. Por favor, elige otro.");
                }
                request.getRequestDispatcher("index.jsp").forward(request, response);
                break;
            case "Nuevo":
            ...
            case "Buscar":
                ...
                request.getRequestDispatcher("index.jsp").forward(request, response);
                break;
            case "buscar":  // Aquí agregamos la nueva acción para buscar productos
                String query = request.getParameter("query");
                ProductoDAO dao = new ProductoDAO();
                List<Producto> resultados = dao.buscarProductos(query);
