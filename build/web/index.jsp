...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="#"><i>GlobalBuy</i></a>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <!-- Reemplaza el código anterior con el formulario de búsqueda -->
                    <form action="Controlador" method="get" class="form-inline my-2 my-lg-0">
                        <input type="text" name="query" style="width:400px" class="form-control mr-sm-2" placeholder="Buscar productos..." required>
                        <button type="submit" name="accion" value="buscar" class="btn btn-outline-info my-2 my-sm-0"><i class="fas fa-search"></i> Buscar</button>
                    </form>
                </ul>
                                ...
                                <div class="tab-pane fade" id="pills-registrar" role="tabpanel">
                                    <form action="Controlador">                               
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" maxlength="10" name="txtdni" class="form-control" placeholder="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="Correo electronico" name="txtemail" class="form-control" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input type="Contraseña" name="txtpass" class="form-control" placeholder="">
                                        </div>                                  
